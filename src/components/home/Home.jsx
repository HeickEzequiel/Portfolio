  ...
  return (
    <div className='relative bg-gray-900 '>
      ...
      <div ref={iniRef} className='relative lg:mt-20 lg:mx-60 xs:mt-32 xs:mx-6 font-platypi text-gray-300'> 
        <div className=''> 
          <AdvancedImage cldImg={fondo} className="lg:relative"/>
        ...
        <div className='lg:relative w-auto h-auto lg:my-20'>
          <p className='lg:relative lg:text-2xl'>Tengo experiencia practica en proyectos utilizando tecnologías como HTML, CSS, Javascript, ReactJs, Redux, Zustand, TanstackQuery, Tailwind, NodeJs, Express, Sequelize, PostgreSQL, entre otras tecnologías que voy adquiriendo permanentemente para crear interfaces de usuario atractivas y funcionales.</p> 
          <br />
        </div>
      ...
      <div className="lg:relative lg:my-20 lg:mx-60 lg:top-0 lg:mb-8 xs:relative xs:top-36 xs:mx-2 xs:mb-40 font-platypi text-gray-300">
        <ol>
          ...
          <li className="underline underline-offset-4 lg:text-2xl animate-fade-down animate-duration-700">🞛 YPF: Agente de soporte IT (2012-2014)</li><br />
          <ul className="lg:text-xl animate-fade-down animate-duration-1000">
        ...
        <hr />
        <p className='lg:text-2xl lg:top-14 lg:mt-10'>Con casi una década liderando y motivando en el ámbito de las artes marciales, mi trayectoria se define por el compromiso y la pasión por la enseñanza. En mi rol actual como Instructor de Artes Marciales, he desarrollado habilidades clave en la gestión de equipos y la motivación tanto individual como grupal, asegurando que cada alumno alcance su máximo potencial. </p> <br />
        <p className='lg:text-2xl lg:top-14 lg:mt-10'>Mi experiencia previa en soporte técnico en YPF SA me ha dotado de una visión integral sobre la resolución de incidentes y la administración de sistemas críticos. Estas competencias, combinadas con mi formación técnica reciente, enriquecen mi perfil profesional, permitiéndome aportar una perspectiva única al entrelazar la precisión técnica con la disciplina marcial.</p> <br />
        <hr />
      </div>
